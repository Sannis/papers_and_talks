...
echo "Sweep: Making graphs for time measures"
...
do
	...
	cat ./graph_sweep_time_bluegene.tpl.gp | sed -e "s/#PFX#/${postfix}/" | gnuplot
	
	cat ./graph_sweep_time_skif.tpl.gp | sed -e "s/#PFX#/${postfix}/" | gnuplot
